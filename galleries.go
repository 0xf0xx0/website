...
var pixelsorts = gallery{
	path:    "https://0xf0xuments.0xf0xx0.eth.limo/pixelsort-gens",
	devPath: "src/views/shrunk",
	images: []galleryImage{
		{
			url:       "/awareness/awareness.jpg",
			sourceURL: "https://www.pexels.com/photo/dramatic-black-and-white-lanzarote-rock-formations-33364468",
		},
		{
		...
		{url: "/misc/waterpark-sorted.jpg"},
		{
			...
			desc: "one of my favorites so far, overlapping sort thresholds is nice x3" +
		...
		},
		{
			...
			desc: "/uj spiral sorting is cool, even cooler when you rotate the image furst" +
		...
		},
		{
			...
			desc: "i love shots like these<br>this was a <i>pain</i> to mask, " +
...
var galleries = map[string]gallery{
	"pixelsorts": pixelsorts,
}
